...
pub fn init_token_pair<'info>(
    ...
    token_pair.stats_a.trade_volume_usd = 0.0;
    token_pair.stats_a.settle_volume_usd = 0.0;

    token_pair.stats_b.pending_withdrawals = 0;
    token_pair.stats_b.fees_collected = 0;
    token_pair.stats_b.order_volume_usd = 0.0;
    token_pair.stats_b.trade_volume_usd = 0.0;
    token_pair.stats_b.settle_volume_usd = 0.0;
